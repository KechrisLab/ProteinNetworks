...
# load global network
load('D:/Research/SOMA/Smoking_AA_Adjusted_1d/5foldCVSmoking_AA_Adjusted_1d_CCcoef_1_/Results/SmCCA5foldSamp100_0.8.Rdata')
# clustering
...
for (z in 1:length(mirGeneModule))
{
  ...
  for (i in 1:nrow(cor_result[[z]]))
  {
    ...
    if(size == 0){
      netD <- paste0("D:/Research/SOMA/Smoking_AA_Adjusted_1d/5foldCVSmoking_AA_Adjusted_1d_CCcoef_1_/", "NetworkEdgeCutpt0/")
      titlePre <- paste0("Net ")
      savePre <- paste0(netD, "Net")
    }else{
      netD <- paste0("D:/Research/SOMA/Smoking_AA_Adjusted_1d/5foldCVSmoking_AA_Adjusted_1d_CCcoef_1_/", "NetworkEdgeCutpt", size, "/")
    ...
    results <- plotMultiOmicsNetworks_PPR_Validation(Abar, bigCor2, mirGeneModule, 
                                                     ...
                                                     type ='Smoking_AA_Adjusted_1d', 
                                                     id = pheno_data$sid,  P1 = p1,
                                                     folder = 'Smoking_AA_Adjusted_1d',
  ...
  write.csv(pc_result,
            paste0('D:/Research/SOMA/Smoking_AA_Adjusted_1d/5foldCVSmoking_AA_Adjusted_1d_CCcoef_1_/pc_correlation_validation_', z, '.csv'),
            row.names = FALSE)
}
# network pruning
for (i in 10:17)
{
  ...
  load(paste0('D:/Research/SOMA/Smoking_AA_Adjusted_1d/Smoking_AA_Adjusted_1dnet', temp_size, '_7AA.Rdata'))
  if (i == 10)
...
createNetworkFromIgraph(graph,"smoking_aa")